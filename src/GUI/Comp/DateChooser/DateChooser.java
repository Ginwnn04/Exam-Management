...
//        setText(false, 0);
    ...
    private void initComponents() {
        ...
        cmdForward = new GUI.Comp.DateChooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new GUI.Comp.DateChooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new GUI.Comp.DateChooser.Button();
        cmdPrevious = new GUI.Comp.DateChooser.Button();
        slide = new GUI.Comp.DateChooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Comp/DateChooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Comp/DateChooser/previous.png"))); // NOI18N
    ...
    private GUI.Comp.DateChooser.Button cmdForward;
    private GUI.Comp.DateChooser.Button cmdMonth;
    private GUI.Comp.DateChooser.Button cmdPrevious;
    private GUI.Comp.DateChooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private GUI.Comp.DateChooser.Slider slide;
