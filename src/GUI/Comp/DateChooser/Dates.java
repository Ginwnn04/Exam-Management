...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new GUI.Comp.DateChooser.Button();
        cmdTu = new GUI.Comp.DateChooser.Button();
        cmdWe = new GUI.Comp.DateChooser.Button();
        cmdTh = new GUI.Comp.DateChooser.Button();
        cmdFr = new GUI.Comp.DateChooser.Button();
        cmdSa = new GUI.Comp.DateChooser.Button();
        cmdSu = new GUI.Comp.DateChooser.Button();
        ...
        cmd21 = new GUI.Comp.DateChooser.Button();
        cmd22 = new GUI.Comp.DateChooser.Button();
        cmd23 = new GUI.Comp.DateChooser.Button();
        cmd24 = new GUI.Comp.DateChooser.Button();
        cmd25 = new GUI.Comp.DateChooser.Button();
        cmd26 = new GUI.Comp.DateChooser.Button();
        cmd27 = new GUI.Comp.DateChooser.Button();
        cmd28 = new GUI.Comp.DateChooser.Button();
        cmd29 = new GUI.Comp.DateChooser.Button();
        cmd30 = new GUI.Comp.DateChooser.Button();
        cmd31 = new GUI.Comp.DateChooser.Button();
        cmd32 = new GUI.Comp.DateChooser.Button();
        cmd33 = new GUI.Comp.DateChooser.Button();
        cmd34 = new GUI.Comp.DateChooser.Button();
        cmd35 = new GUI.Comp.DateChooser.Button();
        cmd36 = new GUI.Comp.DateChooser.Button();
        cmd37 = new GUI.Comp.DateChooser.Button();
        cmd38 = new GUI.Comp.DateChooser.Button();
        cmd39 = new GUI.Comp.DateChooser.Button();
        cmd40 = new GUI.Comp.DateChooser.Button();
        cmd41 = new GUI.Comp.DateChooser.Button();
        cmd42 = new GUI.Comp.DateChooser.Button();
    ...
    private GUI.Comp.DateChooser.Button cmd21;
    private GUI.Comp.DateChooser.Button cmd22;
    private GUI.Comp.DateChooser.Button cmd23;
    private GUI.Comp.DateChooser.Button cmd24;
    private GUI.Comp.DateChooser.Button cmd25;
    private GUI.Comp.DateChooser.Button cmd26;
    private GUI.Comp.DateChooser.Button cmd27;
    private GUI.Comp.DateChooser.Button cmd28;
    private GUI.Comp.DateChooser.Button cmd29;
    private GUI.Comp.DateChooser.Button cmd3;
    private GUI.Comp.DateChooser.Button cmd30;
    private GUI.Comp.DateChooser.Button cmd31;
    private GUI.Comp.DateChooser.Button cmd32;
    private GUI.Comp.DateChooser.Button cmd33;
    private GUI.Comp.DateChooser.Button cmd34;
    private GUI.Comp.DateChooser.Button cmd35;
    private GUI.Comp.DateChooser.Button cmd36;
    private GUI.Comp.DateChooser.Button cmd37;
    private GUI.Comp.DateChooser.Button cmd38;
    private GUI.Comp.DateChooser.Button cmd39;
    private GUI.Comp.DateChooser.Button cmd4;
    private GUI.Comp.DateChooser.Button cmd40;
    private GUI.Comp.DateChooser.Button cmd41;
    private GUI.Comp.DateChooser.Button cmd42;
    ...
    private GUI.Comp.DateChooser.Button cmdFr;
    private GUI.Comp.DateChooser.Button cmdMo;
    private GUI.Comp.DateChooser.Button cmdSa;
    private GUI.Comp.DateChooser.Button cmdSu;
    private GUI.Comp.DateChooser.Button cmdTh;
    private GUI.Comp.DateChooser.Button cmdTu;
    private GUI.Comp.DateChooser.Button cmdWe;
