...
public class PanelQuestion extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tbCauHoi.getColumnModel().getColumnCount() > 0) {
            tbCauHoi.getColumnModel().getColumn(0).setMinWidth(75);
            tbCauHoi.getColumnModel().getColumn(0).setPreferredWidth(75);
            tbCauHoi.getColumnModel().getColumn(0).setMaxWidth(75);
            tbCauHoi.getColumnModel().getColumn(1).setMinWidth(500);
            tbCauHoi.getColumnModel().getColumn(1).setPreferredWidth(500);
            tbCauHoi.getColumnModel().getColumn(1).setMaxWidth(500);
            tbCauHoi.getColumnModel().getColumn(2).setMinWidth(200);
            tbCauHoi.getColumnModel().getColumn(2).setPreferredWidth(200);
            tbCauHoi.getColumnModel().getColumn(2).setMaxWidth(200);
            tbCauHoi.getColumnModel().getColumn(3).setMinWidth(200);
            tbCauHoi.getColumnModel().getColumn(3).setPreferredWidth(200);
            tbCauHoi.getColumnModel().getColumn(3).setMaxWidth(200);
            tbCauHoi.getColumnModel().getColumn(4).setMinWidth(200);
            tbCauHoi.getColumnModel().getColumn(4).setPreferredWidth(200);
            tbCauHoi.getColumnModel().getColumn(4).setMaxWidth(200);
        }
